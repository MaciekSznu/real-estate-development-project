...
const InvestmentView = () => (
  <div className={styles.investmentViewWrapper}>
    <div className={styles.investmentViewTextWrapper} id='inwestycja'>
    ...
    <AwesomeSlider transitionDelay={100} bullets={false} className={styles.sliderWrapper}>
